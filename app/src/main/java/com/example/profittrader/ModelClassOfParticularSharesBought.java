...
public class ModelClassOfParticularSharesBought {
    ...
    ModelClassOfParticularSharesBought(int imageView1, String nameTextView,String amountTextView,String dateTextView, String idTextView,String shareIdTextView, String numberTextView){
